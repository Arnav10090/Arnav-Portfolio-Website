        ...
        <div className="flex flex-col lg:flex-row gap-8 sm:gap-10 md:gap-12 lg:gap-16">
          ...
          <div className="w-full lg:w-[70%]">
            ...
            >
              ...
              <p className="text-base md:text-lg text-gray-600 dark:text-gray-400 mb-0 sm:mb-10 md:mb-12 max-w-2xl mx-auto -mt-0">
                Professional journey and key contributions
              </p>
            </motion.div>

            <motion.div
              className="relative space-y-12 mt-12 md:mt-0"
              initial="hidden"
              whileInView="visible"
              viewport={{ once: true, margin: '-50px' }}
              variants={{
              ...
              {experiences.map((job, index) => (
                ...
                >
                  <div className="pl-6 md:pl-0 relative">
                    ...
                    <Card
                      variant="base"
                      className="p-6 sm:p-8 hover:border-primary-500/30 transition-colors"
                    >
                      <ul className="space-y-3 sm:space-y-4">
                        {job.achievements.map((achievement, i) => (
                          <li
                            key={i}
                            className="flex items-start text-text-secondary leading-relaxed text-sm sm:text-base"
                          >
